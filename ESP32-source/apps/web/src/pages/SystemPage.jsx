      ...
      <article className="panel">
        ...
        <div className="info-table">
          ...
          <div className="info-row">
            <span>边界保护</span>
            <strong>
              {dashboard.boundaryGuard?.enabled
                ? dashboard.boundaryGuard.configured
                  ? dashboard.boundaryGuard.active
                    ? `触发：${dashboard.boundaryGuard.lastTrigger || 'unknown'}`
                    : '已启用'
                  : '等待接线'
                : '关闭'}
            </strong>
          ...
          <div className="info-row">
            ...
            <strong>
              {[
                dashboard.boundaryGuard?.leftFront ? 'LF' : '',
                dashboard.boundaryGuard?.rightFront ? 'RF' : '',
                dashboard.boundaryGuard?.leftRear ? 'LR' : '',
                dashboard.boundaryGuard?.rightRear ? 'RR' : ''
              ]
                .filter(Boolean)
                .join(', ') || '--'}
            </strong>
